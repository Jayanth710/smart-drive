...
# SUBSCRIPTION_ID = os.getenv("PUBSUB_MEDIA_SUBSCRIPTION_ID", "smartdrive-media-extract-sub")
...
from app.media_extractor import media_extractor  # your docling path
...
def handle_message(data):
    return download_and_process(data, media_extractor)
