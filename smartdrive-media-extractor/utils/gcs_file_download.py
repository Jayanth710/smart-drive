...
from app.media_extractor import media_extractor
import logging
...
def download_from_gcs(data: dict):
    """
    ...
    try:
        ...
        res = media_extractor(output_path, data)
        ...
        return {
            "message": "Failed during GCS download or processing for {file_name}",
            "url": None
        }