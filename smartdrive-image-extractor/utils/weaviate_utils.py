...
COLLECTION_NAME = "SmartDriveImages"
...
def setup_weaviate_schema():
    ...
    client.collections.create(
            ...
            wvc.config.Property(
                ...
                data_type= wvc.config.DataType.TEXT,
                description="The type of processing applied to the file",
            ),
            wvc.config.Property(
                name="created_at",
...
def upload_to_weaviate(data: dict, summary: str, embedding: list, processing_type: str) -> dict:
    """
